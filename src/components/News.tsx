...
const News = ({ title, description, anchor, link }: { title: string, description: string, anchor: string, link: ILink }) => {
  return (
    <div className="h-screen w-screen flex justify-center items-center flex-col px-4" >
      <div className="max-w-2xl text-white" >
        {title && <h2 className="text-4xl uppercase" id={anchor}>{title}</h2>}
